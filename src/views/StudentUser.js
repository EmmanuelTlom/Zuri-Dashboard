...
import image from '../assets/img/chrisessien.png'
...
const StudentUser = ({ direction, ...args }) => {
      ...
      <div className="top_section">
        <div className="top_section_wrap">
          <div className="left">
            <div>
              <p>Users</p>
              <small>Users/Students/Chrissy-Essien</small>
            </div>
          </div>
               ...
               <img alt="..." src={image}/>
                <div className="name">
                   ...
                   <div className="student_id">
                       Student ID: <strong>hng0136535pz</strong>
                   </div>
